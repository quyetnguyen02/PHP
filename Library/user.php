        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    ...
                    <a href="create_user.php" class="btn btn-success pull-right"><i class="fa fa-plus">Add New User</i></a>
                </div>
                <?php
                ...
                if($result=$mysqli->query($sql)){
                    if($result->num_rows>0){
                        ...
                        while ($row=$result->fetch_array()){
                            ...
                            echo "<td>";
                            echo '<a href="read_user.php?id=' . $row['id'] . '" class="mr-3"
                                                 title="View Recound" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                            echo '<a href="update_user.php?id=' . $row['id'] . '" class="mr-3"
